    ...
    <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">
            ...
            <li class="nav-item nav-toggle">
                <a class="nav-link modern-nav-toggle pe-0 d-xl-none" data-toggle="collapse">
                    <i class="d-block d-xl-none text-secondary toggle-icon font-medium-4" data-feather="x"></i>
        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            @if (isset($menuData[0]))
                @foreach ($menuData[0]->menu as $menu)
                    @php $route = explode(".", Route::currentRouteName())[0]; @endphp
                    @if($route != $menu->slug || auth()->user()->can("$route.*"))
                        ...
                        @else
                            ...
                            @endphp
                            <li
                                class="nav-item {{ $custom_classes }} {{$route  === $menu->slug ? 'active' : '' }}">
